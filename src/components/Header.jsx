...
function Header() {
    ...
    return (
        <div className="relative flex flex-col justify-between items-center bg-[#151513] pb-[24px] rounded-r-[20px] w-auto max-w-[103px] min-h-screen">
            ...
            <div className="relative flex flex-col items-center gap-[5px] w-full">
                <img
                    className="ml-[7px] w-[40px] h-[40px] active:scale-95 transition-[0.3s] cursor-pointer"
                    src={LogOut}
                />
                <button onClick={() => setIsOpen(!isOpen)} className="z-20 bg-white px-[16px] py-[15px] rounded-full w-full max-w-[56px] active:scale-95 transition-[0.3s] cursor-pointer" > <img className="w-[24px] h-[24px] cursor-pointer" src={Menu} /> </button>
                <motion.div
